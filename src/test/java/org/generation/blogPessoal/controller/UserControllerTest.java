...
public class UserControllerTest {
    ...
    public void dontDuplicateUser() {
        ...
        userService.registerUser(new UserModel("Maria da Silva", "maria_silva@email.com", "123456"));

        HttpEntity<UserModel> requisition = new HttpEntity<UserModel>(
                new UserModel("Maria da Silva", "maria_silva@email.com", "123456"));

        ResponseEntity<UserModel> response = testRestTemplate.exchange("/user/register", HttpMethod.POST, requisition,
                UserModel.class);
    ...
    public void attUser() {
        ...
        Optional<UserModel> userCreated = userService
                .registerUser(new UserModel("Maria da Silva", "maria_silva@email.com", "123456"));

        UserModel userUpdate = new UserModel(userCreated.get().getId(), "Maria da Silva", "maria_silva@email.com",
                "123456");
    ...
    public void listUsers() {
        ...
        userService.registerUser(new UserModel("Sabrina Sanches", "sabrina_sanches@email.com", "sabrina123"));
        userService.registerUser(new UserModel("Ricardo Marques", "ricardo_marques@email.com", "ricardo123"));
